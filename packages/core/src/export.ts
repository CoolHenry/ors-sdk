...
export type { SessionParams, ProjectInfoType, initObserveParams, UserAttrsInfo } from '@/types/init';
...
export { ORS_ERROR_RETHROW, ErrorCategoryEnum, ErrorLevelEnum } from '@/constant';
export * from '@/api';
export { getOrsIdMap } from '@/plugin/serviceObserve'; //添加ors的Id到ubs中
export { initObserve, initSubAppObserve, cleanupSubAppObserve, recordFMPTime } from '@/init';
import { integrationManager } from '@/integrations/utils';
export { updateConfig } from '@/config/samplingRate';

export const addIntegrations = (params: IntegrationsParams) => integrationManager.add(params);
